...
public class ArrayOfGlobalProvince {

    @XmlElement(name = "GlobalProvince", nillable = true)
    protected List<GlobalProvince> globalProvince;
     ...
     * 
     */
    public List<GlobalProvince> getGlobalProvince() {
        if (globalProvince == null) {
            globalProvince = new ArrayList<GlobalProvince>();
        }
