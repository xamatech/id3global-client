...
@XmlRootElement(name = "SupplierUpdate")
public class SupplierUpdate {

    @XmlElementRef(name = "SupplierName", namespace = "http://www.id3global.com/ID3gWS/2013/04", type = JAXBElement.class, required = false)
