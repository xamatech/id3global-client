...
public class ArrayOfGlobalCaseReference {

    @XmlElement(name = "GlobalCaseReference", nillable = true)
    protected List<GlobalCaseReference> globalCaseReference;
     ...
     * {@link GlobalCaseReference }
     * 
     * 
     */
    public List<GlobalCaseReference> getGlobalCaseReference() {
        if (globalCaseReference == null) {
            globalCaseReference = new ArrayList<GlobalCaseReference>();
        }
