...
public class ArrayOfGlobalProfileVersion {

    @XmlElement(name = "GlobalProfileVersion", nillable = true)
    protected List<GlobalProfileVersion> globalProfileVersion;
     ...
     * {@link GlobalProfileVersion }
     * 
     * 
     */
    public List<GlobalProfileVersion> getGlobalProfileVersion() {
        if (globalProfileVersion == null) {
            globalProfileVersion = new ArrayList<GlobalProfileVersion>();
        }
