...
public class ArrayOfGlobalSanctionsPosition {

    @XmlElement(name = "GlobalSanctionsPosition", nillable = true)
    protected List<GlobalSanctionsPosition> globalSanctionsPosition;
     ...
     * {@link GlobalSanctionsPosition }
     * 
     * 
     */
    public List<GlobalSanctionsPosition> getGlobalSanctionsPosition() {
        if (globalSanctionsPosition == null) {
            globalSanctionsPosition = new ArrayList<GlobalSanctionsPosition>();
        }
