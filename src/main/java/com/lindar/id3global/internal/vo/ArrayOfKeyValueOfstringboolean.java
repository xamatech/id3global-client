...
@XmlType(name = "ArrayOfKeyValueOfstringboolean", namespace = "http://schemas.microsoft.com/2003/10/Serialization/Arrays", propOrder = {
    "keyValueOfstringboolean"
})
public class ArrayOfKeyValueOfstringboolean {

    @XmlElement(name = "KeyValueOfstringboolean")
    protected List<KeyValueOfstringboolean> keyValueOfstringboolean;
     ...
     *
     */
    public List<KeyValueOfstringboolean> getKeyValueOfstringboolean() {
        if (keyValueOfstringboolean == null) {
            keyValueOfstringboolean = new ArrayList<KeyValueOfstringboolean>();
        }
