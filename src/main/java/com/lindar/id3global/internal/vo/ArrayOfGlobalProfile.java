...
public class ArrayOfGlobalProfile {

    @XmlElement(name = "GlobalProfile", nillable = true)
    protected List<GlobalProfile> globalProfile;
     ...
     * 
     */
    public List<GlobalProfile> getGlobalProfile() {
        if (globalProfile == null) {
            globalProfile = new ArrayList<GlobalProfile>();
        }
