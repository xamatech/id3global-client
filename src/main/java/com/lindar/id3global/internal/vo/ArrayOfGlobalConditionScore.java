...
public class ArrayOfGlobalConditionScore {

    @XmlElement(name = "GlobalConditionScore", nillable = true)
    protected List<GlobalConditionScore> globalConditionScore;
     ...
     * {@link GlobalConditionScore }
     * 
     * 
     */
    public List<GlobalConditionScore> getGlobalConditionScore() {
        if (globalConditionScore == null) {
            globalConditionScore = new ArrayList<GlobalConditionScore>();
        }
