...
public class ArrayOfGlobalMatrixResultField {

    @XmlElement(name = "GlobalMatrixResultField", nillable = true)
    protected List<GlobalMatrixResultField> globalMatrixResultField;
     ...
     * {@link GlobalMatrixResultField }
     * 
     * 
     */
    public List<GlobalMatrixResultField> getGlobalMatrixResultField() {
        if (globalMatrixResultField == null) {
            globalMatrixResultField = new ArrayList<GlobalMatrixResultField>();
        }
