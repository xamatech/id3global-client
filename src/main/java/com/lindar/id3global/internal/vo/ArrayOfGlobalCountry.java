...
public class ArrayOfGlobalCountry {

    @XmlElement(name = "GlobalCountry", nillable = true)
    protected List<GlobalCountry> globalCountry;
     ...
     * 
     */
    public List<GlobalCountry> getGlobalCountry() {
        if (globalCountry == null) {
            globalCountry = new ArrayList<GlobalCountry>();
        }
