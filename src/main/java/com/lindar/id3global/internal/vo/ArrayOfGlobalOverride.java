...
public class ArrayOfGlobalOverride {

    @XmlElement(name = "GlobalOverride", nillable = true)
    protected List<GlobalOverride> globalOverride;
     ...
     * 
     */
    public List<GlobalOverride> getGlobalOverride() {
        if (globalOverride == null) {
            globalOverride = new ArrayList<GlobalOverride>();
        }
