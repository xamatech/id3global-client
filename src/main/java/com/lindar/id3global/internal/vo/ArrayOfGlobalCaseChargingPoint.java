...
public class ArrayOfGlobalCaseChargingPoint {

    @XmlElement(name = "GlobalCaseChargingPoint", nillable = true)
    protected List<GlobalCaseChargingPoint> globalCaseChargingPoint;
     ...
     * {@link GlobalCaseChargingPoint }
     * 
     * 
     */
    public List<GlobalCaseChargingPoint> getGlobalCaseChargingPoint() {
        if (globalCaseChargingPoint == null) {
            globalCaseChargingPoint = new ArrayList<GlobalCaseChargingPoint>();
        }
